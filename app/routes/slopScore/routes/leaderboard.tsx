...
export async function loader({ request }: LoaderFunctionArgs) {
    try {
        ...
        if (search) {
            ...
            const searchedUserIndex = allAnalyses.findIndex((analysis: any) =>
...
export default function Leaderboard() {
    ...
    const handleSearch = (searchTerm: string) => {
        ...
        navigate(`/slop-score/leaderboard?${params.toString()}`);
    };
    ...
    const handleClearSearch = () => {
        navigate('/slop-score/leaderboard');
    };
    ...
    return (
        ...
        >
            <VStack gap={{ base: "6", md: "8" }} w="full" maxW="4xl" mx="auto">
                ...
                {data.searchContext?.showingContext && (
                    <Button
                        onClick={() => navigate('/slop-score/leaderboard')}
                        bg="white"
                        color="black"
                        _hover={{ bg: "gray.100" }}
                        _active={{ bg: "gray.200" }}
