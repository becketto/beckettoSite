                    ...
                    <VStack gap="3" w="full" pt="4">
                        ...
                        <Box w="full" maxW="400px">
                            <VStack gap="3" display={{ base: "flex", md: "none" }}>
                                ...
                                <RemixLink to="/slop-score/leaderboard" style={{ width: '100%' }}>
                                    <Button
                                        colorScheme="blue"
                                        variant="solid"
                                        size="md"
                                ...
                                <RemixLink to="/slop-score" style={{ width: '100%' }}>
                                    <Button
                                        variant="outline"
                                        colorScheme="blue"
                                        size="md"
                            ...
                            <VStack gap="3" display={{ base: "none", md: "flex" }} w="full">
                                ...
                                <HStack gap="3" w="full">
                                    <Box w="calc(50% - 6px)">
                                        <RemixLink to="/slop-score/leaderboard" style={{ width: '100%', display: 'block' }}>
                                            <Button
                                                colorScheme="gray"
                                                variant="solid"
                                                size="md"
                                ...
                                <HStack gap="3" w="full">
                                    <Box w="calc(50% - 6px)">
                                        <RemixLink to="/slop-score" style={{ width: '100%', display: 'block' }}>
                                            <Button
                                                variant="outline"
                                                colorScheme="blue"
                                                size="md"
